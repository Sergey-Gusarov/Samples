...
(function(debug) {
    ...
    try {
        ...
        console.log = function(log) {
            try {
                StoryCLMBridge.Invoke("consolelog", {
                    log: log
                });
            } catch (ex) {}
        };
        ...
        console.info = function(info) {
            try {
                StoryCLMBridge.Invoke("consoleinfo", {
                    info: info
                });
            } catch (ex) {}
        };
        ...
        console.warn = function(warn) {
            try {
                StoryCLMBridge.Invoke("consolewarn", {
                    warn: warn
                });
            } catch (ex) {}
        };
        ...
        console.error = function(exception) {
            try {
                if (typeof exception.stack !== 'undefined') {
                    StoryCLMBridge.Invoke("consoleerror", {
...
StoryCLM.CustomEvents = (function() {
    ...
    function _set(key, value, callback) {
        ...
        StoryCLMBridge.Invoke("setCustomEvent", {
            key: key,
            value: value + ""
        }, function(data) {
            if (typeof callback === "function")
